<template>
  <div>
    <b-jumbotron
      class="pt-2 pb-2"
      header="麻雀何切るシミュレーター (version 0.5.0)"
      header-level="5"
      bg-variant="dark"
      text-variant="light"
    >
      <b-tabs content-class="mt-3" v-model="tabIndex">
        ...
        <b-tab title="概要" :title-link-class="linkClass(0)">
          ...
          <ul>
            <li>
              牌画像のボタンをクリックすると、牌を追加できます。
            </li>
            <li>
              表示されている牌画像をクリックすると、牌を削除できます。
            </li>
            <li>
        ...
        <b-tab title="計算の詳細" :title-link-class="linkClass(1)">
          ...
          <ul>
            ...
            <li>
              赤牌の自摸は考慮しません。ただし、何切るを考える時点で、赤牌が含まれる手牌は設定可能です。
            </li>
            <li>
              積み棒、不聴罰符、立直棒は点数計算に考慮しません。
            </li>
            <li>
        ...
        <b-tab title="結果の解釈" :title-link-class="linkClass(2)">
          ...
          <ul>
            ...
            <li>
              和了までの間に赤牌を自摸することを考慮していません。赤牌自摸の確率がそこまで高くないため、期待値計算への影響は小さいと考えていますが、実装上可能であれば、この問題は今後対応する予定です。
            </li>
          </ul>
        </b-tab>

        <!-- 更新履歴 -->
        <b-tab title="更新履歴・ToDo" :title-link-class="linkClass(3)">
          <p>更新履歴</p>
          <ul>
            <li>
              version 0.1.0 (2021/01/16): アプリを公開
            </li>
            <li>
          ...
          <ul>
            <li>
              実装や計算量の問題で保留となっているが、いずれは対応したい項目
            </li>
            <li>
              一般手と七対子手の計算を統合する。現在は「手牌の種類」を「一般手」にした場合、七対子手の和了が考慮されない。
            </li>
            <li>
              赤牌自摸を考慮する。現在は赤牌は手牌に設定できるが、途中で赤牌を自摸することは考慮されていない。赤牌受けを考慮することで牌理が多少変わる可能性がある。
            </li>
            <li>
              和了形の役の割合を表示する。期待値に対する各役の寄与度がわかれば、結果を人が解釈しやすくなりそう。
            </li>
          </ul>
        </b-tab>
      </b-tabs>
